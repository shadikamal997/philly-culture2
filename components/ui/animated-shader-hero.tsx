      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white px-6">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto">
          ...
          <div className="space-y-2">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent animate-fade-in-up animation-delay-400">
              {headline.line2}
            </h1>
          </div>
          ...
          {stats && stats.length > 0 && (
            <div className="mt-20 grid grid-cols-3 gap-8 max-w-2xl mx-auto animate-fade-in-up animation-delay-1000">
              {stats.map((stat, index) => (
                <div 
                  key={index} 
                  className={`text-center ${index > 0 && index < stats.length ? 'border-l border-orange-300/30' : ''}`}
                >
                  <div className="text-4xl font-bold bg-gradient-to-r from-orange-300 to-yellow-300 bg-clip-text text-transparent">
                    {stat.value}
                  </div>
                  <div className="text-sm text-orange-100/70 mt-1">{stat.label}</div>
                </div>
              ))}
            </div>
          )}
